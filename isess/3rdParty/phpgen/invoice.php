...
function addPaymentMethod( $mode )
{
    ...
    $this->SetFont( "Arial", "B", 10);
    $this->Cell(10,4, "METHOD OF PAYMENT", 0, 0, "C");
...
function addShippingPrice($tva)
{
    ...
    $this->Cell(40, 4, "DELIVERY PRICE", '', '', "C");
    $this->SetFont( "Arial", "", 10);
