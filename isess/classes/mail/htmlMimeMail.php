    ...
    */
    function htmlMimeMail()
    {
        ...
        */
        ...
        $this->smtp_params['host'] = $helo;//'127.0.0.1';
        $this->smtp_params['port'] = 26;
        $this->smtp_params['helo'] = $helo;//'127.0.0.1';
        $this->smtp_params['auth'] = true;
        $this->smtp_params['user'] = 'info+cherriesng.com';
        $this->smtp_params['pass'] = 'jhfDRt46x#|X1';
    ...
    */
    function send($recipients, $type = 'mail')
    {
        ...
        switch ($type) {
		    ...
		    ini_set("sendmail_from",'info@flytimeevents.com');
                    $result = mail($to, $subject, $this->output, implode(CRLF, $headers),'-f'.'info@flytimeevents.com');
                }
