 ...
 * @access      public
 */
class CPayOnDelivery implements IPayment
{
    public $merchantType;    
    
    const GATEWAY_NAME = 'ON_DELIVERY';
    const GATEWAY_ERROR = 999;
    const MAX_GEN_RETRIES = 100;
    
    /**
     * CPayOnDelivery::__construct()
     * 
    ...
    /**
     * CPayOnDelivery::onReceivePaymentNotification()
     * 
     * @access  public
    ...
    /**
     * CPayOnDelivery::updatePaymentStatus()
     * 
