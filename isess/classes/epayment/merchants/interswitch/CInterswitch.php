 ...
 * @access      public
 */
class CInterswitch implements IPayment
{
    public $merchantType;    
    
    const GATEWAY_NAME = 'INTERSWITCH';
    const GATEWAY_ERROR = 999;
    const MAX_GEN_RETRIES = 100;
    
    /**
     * CInterswitch::__construct()
     * 
    ...
    /**
     * CInterswitch::onReceivePaymentNotification()
     * 
     * @access  public
    ...
    /**
     * CInterswitch::updatePaymentStatus()
     * 
